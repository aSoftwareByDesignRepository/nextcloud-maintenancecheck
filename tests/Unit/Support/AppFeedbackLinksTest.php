...
final class AppFeedbackLinksTest extends TestCase
{
	...
	{
		$links = new AppFeedbackLinks('maintenancecheck', 'MaintenanceCheck');
		$noisy = '/apps/maintenancecheck/?IKnowThatThisIsABigInstanceAndTheUpdateRequestCouldRunIntoATimeoutAndHowToRestoreABackup=IAmSuperSureToDoThis';
		self::assertSame('/apps/maintenancecheck/', $links->sanitizePageUrl($noisy));
	}
