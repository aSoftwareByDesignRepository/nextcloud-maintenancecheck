...
final class SupportUsSectionContractTest extends TestCase {
	...
	public function testCssContractHasFocusAndReducedMotion(): void {
		...
		self::assertStringContainsString('mn-support-us', $css);
		...
		if (is_file($dedicated)) {
			...
			self::assertStringContainsString('#app-content.mn-app--admin-support-us ul.mn-support-us-page__trust', $pageCss);
			...
			self::assertMatchesRegularExpression(
				'/\.mn-support-us--page \.mn-support-us__primary\s*\{[^}]*max-width:\s*none/s',
				$pageCss,
