...
namespace OCA\MaintenanceCheck\License;

use OCA\MaintenanceCheck\Config\VendorPublicKey;

/**
 * MN2 wire format (SPEC §8.1): `MN2.<payload_b64url>.<signature_b64url>`,
 ...
 */
final class Mn2Codec
{
	public const FORMAT = 'MN2';
	public const VERSION = 2;
	public const PRODUCT = 'maintenancecheck';
	...
	public static function canonicalJson(array $payload): string
	{
		...
		if ($json === false) {
			throw new \RuntimeException('MN2 canonical JSON encode failed.');
		}
		return $json;
	}
