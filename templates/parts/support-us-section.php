 ...
 * @var \OCP\IL10N $l
 * @var \OCA\MaintenanceCheck\Support\SupportUsLinks $supportUsLinks
...
if (!isset($supportUsLinks) || !$supportUsLinks instanceof \OCA\MaintenanceCheck\Support\SupportUsLinks) {
	return;
}
